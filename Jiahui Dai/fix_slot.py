        ...
        while True:
            if (len(self.packet_list) > 0) and (child is not None):
                ...
                if RANDOMIZATION_SCHEME == EXPOVARIATE:
                    ...
                    while (random.random() < TX_SLEEP_RATE_1) and (SIM_TIME > self.sleep_time_total + sleep_time):
                ...
                if RANDOMIZATION_SCHEME == EXPOVARIATE:
                    ...
                    while (random.random() < RX_SLEEP_RATE_1) and (SIM_TIME > self.sleep_time_total + sleep_time):
                        sleep_time += SLOT_TIME
                else :
...
if __name__ == '__main__':
    ...
    if RANDOMIZATION_SCHEME == EXPOVARIATE:
        ...
        print("tx sleep rate: %f" % TX_SLEEP_RATE_1)
        print("rx sleep rate: %f" % RX_SLEEP_RATE_1)
    else:
