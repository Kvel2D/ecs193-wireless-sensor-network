...
/*        Serial.print("number of successful packet: ");
        ...
        Serial.println(popped.packet_age);
        Serial.println(popped.packet_number);
        sprintf(log_output, "%u  %d  %u  %d  %d", sleep_log, tx_time, total_time, popped.packet_number, popped.packet_age);
        Serial.print(log_output); 
        Serial.println(popped.reading);
    } else {
