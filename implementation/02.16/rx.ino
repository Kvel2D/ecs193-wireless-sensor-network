...
void loop() {
  // long sleep_time = random(500, 900);
  long sleep_time = expovariate(50.0f);
  delay(sleep_time);
  total_sleep_time += sleep_time;


  unsigned long awake_time = millis();
  ...
  // Serial.println("Going to sleep at");
  // unsigned long diff = millis() - awake_time;

  // Serial.print("Was awake for "); Serial.println(diff);
}
